          ...
          <tbody>
            {farms.map((farm, index) => (
              <tr key={index}>
                ...
                <td><button className="bg-red-500 text-white px-4 py-2">Product</button></td>
              </tr>
            ))}
          </tbody>
        </table>
...
//               <span className="font-bold">Farm Image:</span>
...
//             </div>
//             <div className="flex flex-wrap justify-between mt-2">
//               <span className="font-bold">Farm Land Type:</span>
//               <span>{farm.type}</span>
//             </div>
//             <div className="flex flex-wrap justify-between mt-2">
...
//               <button className="bg-green-500 text-white px-4 py-2">Map</button>
//               <button className="bg-red-500 text-white px-4 py-2">Product</button>
//             </div>
//           </div>
//         ))}
//       </div>
